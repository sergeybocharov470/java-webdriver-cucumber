...
public class PredefinedStepDefs {
    ...
    @And("element with xpath {string} should contain text1 {string}")
    public void elementWithXpathShouldContainText1(String xpath, String text) {
        String actualText = getDriver().findElement(By.xpath(xpath)).getText();
    ...
    public void coiShouldSeePageTitleAs(String title) {
